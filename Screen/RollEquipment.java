...
public class RollEquipment extends JFrame {
    ...
    private JLabel RollEquipment , YougotSword , StatsSword , YougotHelmet , StatsHelmet , YougotChestplate , StatsChestplate , YougotLeggings , StatsLeggings , YougotBoots , StatsBoots , Money;
    ...
    void setButton(){
        ...
        Sword.addActionListener((ActionEvent e)->{
            if(stats.getMoney() >= Sword_Price){
                ...
                YougotSword.setText("You got : 1/" + equipment.SwordValue);
                StatsSword.setText("Stats : +" + equipment.RollResult + " ATK");
            }
        });
        add(Sword);
        ...
        Helmet.addActionListener((ActionEvent e)->{
            if(stats.getMoney() >= Helmet_Price){
                ...
                Money.setText("Money : " + stats.getMoney());
                YougotHelmet.setText("You got : 1/" + equipment.HelmetValue);
                StatsHelmet.setText("Stats : +" + equipment.RollResult + " Hp");
            }
        });
        add(Helmet);
        ...
        Chestplate.addActionListener((ActionEvent e)->{
            if(stats.getMoney() >= Chestplate_Price){
                ...
                Money.setText("Money : " + stats.getMoney());
                YougotChestplate.setText("You got : 1/" + equipment.ChestplateValue);
                StatsChestplate.setText("Stats : +" + equipment.RollResult + " Hp");
            }
        });
        add(Chestplate);
        ...
        Leggings.addActionListener((ActionEvent e)->{
            if(stats.getMoney() >= Leggings_Price){
                ...
                Money.setText("Money : " + stats.getMoney());
                YougotLeggings.setText("You got : 1/" + equipment.LeggingsValue);
                StatsLeggings.setText("Stats : +" + equipment.RollResult + " Hp");
            }
        });
        add(Leggings);
        ...
        Boots.addActionListener((ActionEvent e)->{
            if(stats.getMoney() >= Boots_Price){
                ...
                equipment.RollBoots();
                Money.setText("Money : " + stats.getMoney());
                YougotBoots.setText("You got : 1/" + equipment.BootsValue);
                StatsBoots.setText("Stats : +" + equipment.RollResult + " Hp");
            }
        });
        add(Boots);
